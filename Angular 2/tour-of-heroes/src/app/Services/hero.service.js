...
var mock_heroes_1 = require("../Config/mock-heroes");
...
var HeroService = (function () {
    ...
    HeroService.prototype.getHeroes = function () {
        return Promise.resolve(mock_heroes_1.HEROES); // A Promise promises to call back when the results are ready. (act on the promise in the get Heroes method in the AppComponent)
    };
    ...
    HeroService.prototype.getHeroHttp = function (id) {
